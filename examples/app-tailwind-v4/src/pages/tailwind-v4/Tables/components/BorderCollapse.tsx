...
export function BorderCollapse() {
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <p className="text-sm font-medium text-neutral-text">Border Collapse (Separate)</p>
      ...
      <div className="space-y-2">
        <p className="text-sm font-medium text-neutral-text">Border Collapse (Collapse)</p>
